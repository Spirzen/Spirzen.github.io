	...
	switch (projectId) {
		...
		case "ITUniverse":
			content = `
				...
				<p>В индустрии информационных технологий отсутствует единственный, независимый и глубоко верифицированный источник системных знаний, и специалист собирает знания из десятков несогласованных источников, формируя у себя внутреннюю карту, полную семантических разломов и ложных аналогий. Последствия — ошибки проектирования, неоптимальные решения, высокая стоимость поддержки, сложность передачи знаний внутри команды.</p>
				<p>"Вселенная IT" закрывает эту потребность. Она предоставляет:</p>
				<ul align="left">
